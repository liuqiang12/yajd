        ...
        <div id="dialog">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" style="width: 150px" value="${ryEntity.zw}"  name="zw"  class="validate[required,length[0,100]]" ></td>
                </tr>
                <tr>
                    <td class="bt">联系方式<i style="color:red;font-style:normal;">*</i></td>
                    <td>
                        <input type="text" style="width: 150px" value="${ryEntity.lxfs}"  name="lxfs" class="validate[required,length[0,200]]" >
                    </td>
                    <td class="bt">备注<i style="color:red;font-style:normal;">*</i></td>
                    <td><input type="text" style="width: 150px" value="${ryEntity.bz}"  name="bz"  class="validate[required,length[0,200]]" ></td>
                </tr>
                <tr>
