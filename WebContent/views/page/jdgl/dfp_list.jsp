...
<head>
    ...
    <script>
        ...
        function getDataList(index){
            ...
            $.ajax({
                type: "POST",
                url: contextPath+"/tJdJdxxController/queryPageList?jdxxBzInt=0",
                ...
                success: function(msg){
                    ...
                    $.each(msg.rows,function(idx,row){
                        ...
                        "                   <td>" +
                        "                       <span class='btn_g'>" +
                        "                           <button class='button btn_fpry' onclick=\"fpryWin('"+row.id+"')\" >分配人员</button>" +
                        "                       </span>" +
        ...
        <div class="box span10 oh">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                <tr id="grid_head_tr">
                    ...
                    <th style="width:13%;min-width:218px;">操作</th>
                </tr>
            </table>
        </div>
    </div>
