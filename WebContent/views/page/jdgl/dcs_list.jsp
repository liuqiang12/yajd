...
<script>
    ...
    function getDataList(index){
        ...
        $.ajax({
            type: "POST",
            url: contextPath+"/tJdJdxxController/queryPageList?jdxxBzInt=2",
            ...
            success: function(msg){
                ...
                $.each(msg.rows,function(idx,row){
                    ...
                    var gridBody = "<tr class='addGrid_data_tr'>"+
                        ...
                        "                   <td><a href='javascript:void(0);' onclick=\"downFile('T_JD_JDXX','"+row.id+"','jyfafj')\"><img src='"+contextPath+"/lib/images/word.png' alt=''></a></td>"+
                        "                   <td style'text-align:left;'>"+bz+"</td>"+
                        "                   <td></td>"+
                        "                   <td>"+cbrName+"</td>"+
                        "                   <td class='btn_group'>" +
                        "                       <span class='btn_g'>" +
                        "                           <button class='button btn_cs' onclick=\"csWin('"+row.id+"')\" >初审</button>" +
                        "                       </span>" +
                        "                       <span class='btn_g'>" +
    ...
    function csWin(id){
        ...
        top.layer.confirm('是否通过初审', {
            ...
            $.ajax({
                ...
                type:"POST",
                //提交的网址
                url:contextPath+"/tJdJdxxController/csUpdate",
                //提交的数据
                data:{
                    id:id
                },
