...
<script>
    ...
    function getDataList(index){
        ...
        $.ajax({
            type: "POST",
            url: contextPath+"/tJdJdxxController/queryPageList?jdxxBzInt=4",
                ...
                $.each(msg.rows,function(idx,row){
                    ...
                    if('FSWC' == row.jdxxBz){
                        ...
                        var gridBody = "<tr class='addGrid_data_tr'>"+
                            ...
                            "                   <td class='btn_group'>" +
                            "                       <span class='btn_g'>" +
                            "                           <button class='button btn_cs' onclick=\"ywcWin('"+row.id+"')\" >已完成</button>" +
                            "                       </span>" +
                            "                       <span class='btn_g'>" +
                            "                           <button class='button btn_fpry' onclick=\"fhsybWin('"+row.id+"')\" >返回上一步</button>" +
                            "                       </span>" +
    ...
    function ywcWin(id){
        ...
        top.layer.confirm('是否完成', {
            ...
            $.ajax({
                ...
                async:false,
                //提交的网址
                url:contextPath+"/tJdJdxxController/wcUpdate",
                //提交的数据
                data:{
                    id:id
                },
