...
(function($){
    ...
    function _67a(_67b){
        ...
        if(opts.pagination){
            ...
            _682.pagination({total:0,layout:['list','sep','first','prev','manual','next','last','refresh'],pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_683,_684){
